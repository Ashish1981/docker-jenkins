...
RUN apt-get update && apt-get upgrade -y && apt-get install -y git curl | bash && apt-get install -y git-lfs && git lfs install && rm -rf /var/lib/apt/lists/*
ARG user=jenkins
ARG group=jenkins
ARG uid=1000
ARG gid=1000
